...
path = r"C:/Users/Ankit/OneDrive/Desktop/AP/Backend/uploads"
path1= r"C:/Users/Ankit/OneDrive/Desktop/AP/Backend/thief"
storepath=r"C:/Users/Ankit/OneDrive/Desktop/AP/Frontend/src/Components/Images"
storepath1=r"C:/Users/Ankit/OneDrive/Desktop/AP/Frontend/src/Components/imagesThief"
dbpath=r"C:/Users/Ankit/OneDrive/Desktop/AP/Backend/intermediate"
dbpath1=r"C:/Users/Ankit/OneDrive/Desktop/AP/Backend/thief_data/"
aug_in=r"C:/Users/Ankit/OneDrive/Desktop/AP/Backend/augmentation/"
aug_out=r"C:/Users/Ankit/OneDrive/Desktop/AP/Frontend/src/Components/augmented"

def prediction_and_write(imgpath1):
    fps=imagegenerator()
    imgpath= r"C:/Users/Ankit/OneDrive/Desktop/AP/Backend/uploads/" + imgpath1[0]
    dbpath2=dbpath
    storepath=r"C:/Users/Ankit/OneDrive/Desktop/AP/Frontend/src/Components/Images/"
    remove(storepath)
    
    recognition = DeepFace.find(
        img_path=imgpath, db_path=r"C:/Users/Ankit/OneDrive/Desktop/AP/Backend/intermediate/", enforce_detection=False)
    print(recognition)
    n = 1
    arr=[]
    ...
    os.remove(imgpath)
    os.chdir(r"C:/Users/Ankit/OneDrive/Desktop/AP/Frontend/src/Components/Images/")
    lst=os.listdir()
    i=0
    while i<len(lst)-5:
        os.remove(lst[i])
...
def imagegenerator():
    cam=VideoFileClip(r"C:/Users/Ankit/OneDrive/Desktop/AP/Backend/Video/WhatsApp Video 2023-08-29 at 22.27.32.mp4")
    dur=int(cam.duration)
    cam = cv2.VideoCapture(r"C:/Users/Ankit/OneDrive/Desktop/AP/Backend/Video/WhatsApp Video 2023-08-29 at 22.27.32.mp4")
    currentframe = 1
    while (True):
        ret, frame = cam.read()
        if ret:
            name = r"C:/Users/Ankit/OneDrive/Desktop/AP/Backend/intermediate/" + str(currentframe) + '.jpg'
...
def textfilegen(recognition):
    ...
    no=df.shape[0]
    text_file = open(r"Backend/test.txt", "w")
    lis=[]
    for k in range(no):
        y=df['identity'][k]
        new_str = ""
    ...
    file1 = open(r"Backend/test.txt","w")
    for i in lis1:
        file1.write(i +"\n")
